 ...
 */
public class ProcesadorInfoReactivoImp extends ProcesadorEventosAbstracto
	...
	public void para() {
		throw new java.lang.UnsupportedOperationException(
				"El metodo para() an no est implementado.");
	}
	...
	public synchronized void procesarInfoControlAgteReactivo(
		...
		// procesador
		automataControl.procesaInput(infoParaProcesar.getInput(),
				infoParaProcesar.getvaloresParametrosAccion());
