...
public class AccionesSemanticasImp extends AccionesSemanticasAbstracto {
	 ...
	 * @uml.property name="accionesSemanticas"
	 */
	public void setAccionesSemanticas(
			AccionesSemanticasAgenteReactivo accionesSemanticas) {
		this.accionesSemanticas = accionesSemanticas;
	}
	 ...
	 */
	@Override
	public void ejecutarAccion(String accion, Object[] parametros,
	...
	public void run() {
		try {
			...
			Logger.getLogger(AccionesSemanticasImp.class.getName()).log(
	...
	protected void ejecutarAccionBloqueante(String nombre, Object[] parametros)
			throws ExcepcionEjecucionAcciones {
