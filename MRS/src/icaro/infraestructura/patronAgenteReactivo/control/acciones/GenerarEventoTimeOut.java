...
public class GenerarEventoTimeOut extends Thread {
	...
	public GenerarEventoTimeOut(long milis, String nombre, String origen,
	...
	public void run() {
		try {
			...
			if (itfUsoAgenteDestinatario == null) {
				itfUsoAgenteDestinatario = (ItfUsoAgenteReactivo) repositorio
						.obtenerInterfaz(NombresPredefinidos.ITF_USO + destino);
			}
			itfUsoAgenteDestinatario.aceptaEvento(new EventoRecAgte(nombre,
					origen, destino));
		} catch (Exception e) {
