...
public class ExtractedInfo {
	...
	// El contenido puede ser un objeto o una colecci�n de entidades que se
	// obtiene a partir de mensajes o de eventos
	// Se puede crear la evidencia a partir de una collecci�n de objetos o con
	// una colecci�n vac�a a la que
