...
public class InterpreteEventosSimples {
	...
	public ExtractedInfo generarExtractedInfo(EventoSimple evento) {
		...
		if (evento == null) {
			...
			// Transformamos el atributo msg del evento y la lista de parámetros
			// en un objeto
			// de la clase EvenInfo donde se incluyen los atributos del evento y
			// los valores de cada atributo
			// Si el que envia el evento es un recurso de visualiación
			// transformamos el contenido
			// del evento en un objeto InfoUsuario que tiene un atributo
			// petición y otro con la lista de objetos
