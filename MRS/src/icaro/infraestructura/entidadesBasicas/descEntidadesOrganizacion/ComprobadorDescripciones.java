...
public class ComprobadorDescripciones {
	...
	public DescComportamientoAgente comprobarAgenteReactivo(
		...
		if (rutaClaseAcciones == null) {
			if (rutaDirectorioCompt == null)// se valida la ruta y luego que
											// exista la clase
		...
		rutaClaseAcciones = validarRutaClaseEntidad(rutaClaseAcciones,
				rutaDirectorioCompt, identComportmto);
	...
	public boolean validarRutaReglasAgteADO(String rutaEntidad,
		...
		String rutaDirectorioCompt = NombresPredefinidos.RUTA_AGENTES_APLICACION
				...
				+ "."
				+ NombresPredefinidos.CARPETA_REGLAS;
		String rutaFicheroReglasPorDfto = rutaDirectorioCompt + "."
				+ NombresPredefinidos.CARPETA_REGLAS + "."
				+ NombresPredefinidos.FICHERO_REGLAS;
