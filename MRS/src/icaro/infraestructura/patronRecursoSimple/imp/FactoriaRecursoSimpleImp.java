...
public class FactoriaRecursoSimpleImp extends FactoriaRecursoSimple {
	...
	public void crearRecursoSimple(DescInstanciaRecursoAplicacion recurso) {
		...
		try {
			...
			// logger.debug("Factoria de recurso simple: Creando el recurso "+
			// recurso);
			ItfUsoConfiguracion config = (ItfUsoConfiguracion) repoIntfaces
			...
			// consigo el recurso
			ItfUsoAutomataEFsinAcciones itfAutomata = (ItfUsoAutomataEFsinAcciones) ClaseGeneradoraAutomataEFsinAcciones
			...
			repoIntfaces.registrarInterfaz(NombresPredefinidos.ITF_GESTION
					+ idRecurso, (ItfGestionRecursoSimple) objRecurso);
			repoIntfaces.registrarInterfaz(NombresPredefinidos.ITF_USO
					+ idRecurso, (ItfUsoRecursoSimple) objRecurso);
