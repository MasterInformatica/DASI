 ...
 * @author FGarijo
 */
public class RobotBloqueado extends EstadoAbstractoMovRobot implements
	...
	public RobotBloqueado(MaquinaEstadoMovimientoCtrl maquinaEstados) {
		// en este estado se puede simular que el robot no avanza, pero que esta
		// intentando salir del atasco
		// esto puede durar un tiempo. al final o ha salido del atasco para
		// continuar hacia el destino o se queda
		// esperando ordenes
		super(
				maquinaEstados,
	...
	public void continuar() {
		// deberia intentar salir del bloqueo durante un tiempo, si no lo
		// consigue notifica al agente
		// lo podria hacer generando una notificacion que va al controlador del
		// agente
		this.trazas.trazar(this.identAgente + "."
	...
	public boolean estamosEnDestino(String identDest) {
		...
		// this.trazas.trazar (this.identAgente
		// +"."+this.getClass().getSimpleName(),
		// " ignoro la operacion porque estoy atascado ",
		// InfoTraza.NivelTraza.debug);
	}
	...
	public String getIdentEstadoMovRobot() {
		return MaquinaEstadoMovimientoCtrl.EstadoMovimientoRobot.RobotBloqueado
				.name();
	}
