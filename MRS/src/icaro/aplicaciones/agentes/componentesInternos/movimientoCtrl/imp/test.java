...
public class test extends javax.swing.JFrame {
	...
	public test() {
		initComponents();
		coordActuales = new Coordinate(this.robot.getX(), robot.getY(),
				robot.getWidth());
		coordDestino = new Coordinate(this.jLabel2.getX(), jLabel2.getY(),
				jLabel2.getWidth());
		// double incrX, incrY;
		...
		this.distanciaArecorrer = (float) Math.sqrt(incrX * incrX + incrY
				* incrY);
		// valor de y cuando x vale 0 coordY.y = pendiente * coordActuales.x
		// +coordActuales.y
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
		...
		//
		// robot.setBounds((int)coordActuales.x, (int)coordActuales.y,
		// robot.getWidth(), robot.getHeight());
		// if ( Math.abs(coordActuales.x - coordDestino.x)<2 ||
		// Math.abs(coordActuales.y -
		// coordDestino.y)<2)System.out.println("YA");
		...
		// this.coordActuales.y = coordActuales.y+this.dirY*incrementoDistancia;
			...
			// constIncrX =(incrementoDistancia/
			// Math.sqrt(1+pendienteRecta*pendienteRecta));
			// this.coordActuales.x = coordActuales.x +
			// incrementoDistancia*dirX;
			this.coordActuales.y = this.coordActuales.y + pendienteRecta
					* incrementoDistancia * dirY;
			this.coordActuales.x = coordActuales.x + incrementoDistancia * dirX;

			// this.coordActuales.y = coordActuales.y +
			// pendienteRecta*incrementoDistancia*dirY - this.b;
			// constIncrY = (this.coordActuales.x
			// +constIncrX)*this.pendienteRecta*dirY;
		}
		...
		if ((coordActuales.x - coordDestino.x) * dirX >= 0
				&& (coordActuales.y - coordDestino.y) * dirY >= 0) {
			parar = true;
