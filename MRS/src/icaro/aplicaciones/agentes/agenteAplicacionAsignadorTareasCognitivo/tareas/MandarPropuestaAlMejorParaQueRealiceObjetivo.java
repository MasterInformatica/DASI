...
public class MandarPropuestaAlMejorParaQueRealiceObjetivo extends TareaSincrona {
	...
	public void ejecutar(Object... params) {
		try {
			...
			// if (! infoDecision.getheInformadoAlmejorParaQueAsumaElObjetivo()
			...
			trazas.aceptaNuevaTraza(new InfoTraza(
					...
					"IdentObjetoPropuesta: "
							...
							+ VocabularioRosace.MsgPropuesta_Para_Aceptar_Objetivo
