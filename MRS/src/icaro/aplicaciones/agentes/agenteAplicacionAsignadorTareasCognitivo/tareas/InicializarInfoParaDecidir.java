...
public class InicializarInfoParaDecidir extends TareaSincrona {
	...
	public void ejecutar(Object... params) {
		try {
			...
			InfoParaDecidirAQuienAsignarObjetivo infoDecisionAgente = new InfoParaDecidirAQuienAsignarObjetivo(
			...
			// Activo un timeout para la decision. Cuando venza se decidira que
			// hacer en funcion de la situacion del agente
