...
/**
 * 
 * @author FGarijo Esta clase debe servir para envio de items de informacion -
 *         representados mediante identificadores - de un tema o asunto en que
 *         un agente quiera informar a otro agente. Tambien puede utilizarse
 *         como base para crear otros items mas complicados como propuestas o
 *         peticiones, mediante herencia
 */
public class InfoInteraccionBasica {
	...
	public InfoInteraccionBasica(String agentId, String temaId,
			String iteracionId) {
