...
public class PeticionEstatusComunicacionConJefe extends TareaSincrona {
	...
	public void ejecutar(Object... params) {
		try {
			...
			PeticionAgente peticionEstatus = new PeticionAgente(
					nombreAgenteEmisor);
			peticionEstatus
					.setMensajePeticion(VocabularioRosace.MsgPeticionEnvioEstatusComunicacionConJefe);
			peticionEstatus
					.setJustificacion(VocabularioRosace.MsgJustificPetionEstatusComunConJefe);
			ArrayList<String> agentesEquipo = equipoInfo
					.getTeamMemberIDsWithThisRol(equipoInfo
							.getTeamMemberRol(nombreAgenteEmisor));
			...
			trazas.aceptaNuevaTraza(new InfoTraza(nombreAgenteEmisor,
					"Enviamos la peticion " + peticionEstatus,
					InfoTraza.NivelTraza.info));
			// infoDecision.setMi_eval(miEvaluacion.getEvaluacion()); Ya tengo
			// mi evaluacion por tanto no la redefino
			...
			this.getComunicator().informaraGrupoAgentes(peticionEstatus,
					agentesEquipo);
			...
			this.generarInformeTemporizadoFromConfigProperty(
					VocabularioRosace.IdentTareaTimeOutRecibirEstatusComunicacionConJefe,
