	...
	public void ejecutar(Object... params) {
		...
		try {
			...
			PropuestaAgente miPropuesta = new PropuestaAgente(
					nombreAgenteEmisor);
			miPropuesta
					.setMensajePropuesta(VocabularioRosace.MsgPropuesta_CambioRolaIgualitario);
			miPropuesta
			...
			this.getComunicator().informaraGrupoAgentes(miPropuesta,
					miEquipo.getTeamMemberIDsWithMyRol());
			InfoCambioRolAgente infoCambioRol = new InfoCambioRolAgente(
					nombreAgenteEmisor, miEquipo,
			...
			this.generarInformeTemporizadoFromConfigProperty(
					VocabularioRosace.IdentTareaTimeOutRecibirRespuestasEquipo,
