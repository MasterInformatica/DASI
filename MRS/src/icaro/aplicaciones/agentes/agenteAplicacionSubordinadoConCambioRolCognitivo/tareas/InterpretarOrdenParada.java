...
public class InterpretarOrdenParada extends TareaSincrona {
	...
	public void ejecutar(Object... params) {
		try {
			...
			// se deberia verificar que el ordenante tiene autoridad para dar la
			// orden
			...
			// cuando existe
			if (verificarAutoridad(ordenParar.getIdentEmisor())) { // se procede
																	// a
																	// ejecutar
																	// la orden
																	// de parada
				...
				((ItfUsoMovimientoCtrl) infoCpteMov.getitfAccesoComponente())
						.parar();
