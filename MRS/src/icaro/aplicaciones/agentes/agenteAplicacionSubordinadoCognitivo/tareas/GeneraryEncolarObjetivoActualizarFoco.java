...
public class GeneraryEncolarObjetivoActualizarFoco extends TareaSincrona {
	...
	public void ejecutar(Object... params) {
		...
		try {
			...
			// de la victima
			String identVictim = propuestaAceptada
					.getidentObjectRefAcetPropuesta();
			...
			// "RecursoEstadistica1");
			itfUsoRecursoEstadistica = (ItfUsoRecursoEstadistica) NombresPredefinidos.REPOSITORIO_INTERFACES_OBJ
					.obtenerInterfaz(NombresPredefinidos.ITF_USO
							+ "RecursoEstadistica1");
			long tiempoActual = System.currentTimeMillis();
			String refVictima = identVictim;
			itfUsoRecursoEstadistica
					.escribeEstadisticaFicheroTextoPlanoTRealAsignacionVictimasRobots(
							tiempoActual, refVictima, nombreAgenteEmisor,
							miEvaluacion);
