...
public class MoverseAsalvarVictima extends TareaSincrona {
	...
	public void ejecutar(Object... params) {
		...
		trazas.aceptaNuevaTrazaEjecReglas(
				identAgente,
				"Se ejecuta la tarea " + identTarea + " Victima salvada  :  "
						+ victima + "Objetivo conseguido :  " + objConseguido
						+ "Nuevo objetivo a conseguir  :  " + nuevoObj
						+ " Los objetivos en la cola son  :  "
						+ misObjs.getMisObjetivosPriorizados() + "\n");
		log.debug("Se ejecuta la tarea " + identTarea + " Victima salvada  :  "
				+ victima + "Objetivo conseguido :  " + objConseguido
				+ "Nuevo objetivo a conseguir  :  " + nuevoObj
				+ " Los objetivos en la cola son  :  "
				+ misObjs.getMisObjetivosPriorizados() + "\n");
		...
		if (nuevoObj.getPriority() > 0) {
			// if
			// (!objActual.getobjectReferenceId().equals(victima.getName()))//
			// no se hace nada y se indica un error pq el objetivo debe ser el
			// que esta como mas prioritario
			// {
			// trazas.trazar(this.getIdentAgente(), "Se ejecuta la tarea " +
			// this.getIdentTarea()
			// +
			// " El ident de la victima debe coindidir con el del objetivo mas prioritario :  "
			// + victima + "\n", InfoTraza.NivelTraza.error);
			// } else {
			// Objetivo nuevoObj = misObjs.getobjetivoMasPrioritario();
			// if (nuevoObj != null) {

			victima = victimasArescatar.getVictimToRescue(nuevoObj
			...
			// "Se elimina el objetivo  " + objActual
			// + " Los objetivos en la cola son  :  " +
			// misObjs.getMisObjetivosPriorizados() + "\n");
			trazas.aceptaNuevaTrazaEjecReglas(
					identAgente,
					"Se ejecuta la tarea "
							+ identTarea
							+ " Se inicia el movimiento  para salvar a la victima :  "
							+ victima + "\n" + "Objetivo conseguido :  "
							+ objConseguido + "Nuevo objetivo a focalizar  :  "
							+ nuevoObj + " Los objetivos en la cola son  :  "
							+ misObjs.getMisObjetivosPriorizados() + "\n");
			...
			trazas.aceptaNuevaTrazaEjecReglas(
					...
					"Se ejecuta la tarea "
							+ identTarea
							+ "Nuevo objetivo a focalizar  :  "
							+ nuevoObj
							+ " Prioridad del objetivo : "
							+ nuevoObj.getPriority()
