...
public class ProcesarInfoRolAgente extends TareaSincrona {
	...
	public void ejecutar(Object... params) {
		try {
			...
			// Si el equipo es jerarquico y el Rol es de agente asignador de
			// tareas entonces
			...
			if (infoRolRecibido.getidentRolAgte().equals(
				...
				miEquipo.setidentAgenteJefeEquipo(infoRolRecibido
						.getAgteIniciadorId());
			this.getEnvioHechos()
					.eliminarHechoWithoutFireRules(infoRolRecibido);
			this.getEnvioHechos().actualizarHecho(miEquipo);
			trazas.trazar(
					this.getIdentAgente(),
					"Se procesa el InfoRol recibido :  "
							+ infoRolRecibido.toString(),
