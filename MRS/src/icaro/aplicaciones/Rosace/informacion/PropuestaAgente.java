...
public class PropuestaAgente implements Serializable {
	...
	public String identObjectRefPropuesta; // identificador de un objeto o
	...
	public String toString() {
		if (justificacion == null)
			return "Propuesta:-> Agente Emisor :" + identAgente
					+ " ObjectRefPropuesta :+" + identObjectRefPropuesta
