...
public class DecisionAgente implements Serializable {
	...
	// public String decisionInfo; //creo que actualmente este campo no se
	// utiliza
	// public String IdDecisionInfo; // identificador que permite identificar el
	// objeto sobre el que se realiza la decision P ej la victima
	public String identObjectRefDecision; // identificador de un objeto o
											// contexto al que se refiere la
											// propuesta
	...
	// return "Agente Emisor :" + identAgente + " MensajePropuesta :+" +
	// decisionMsg + "  Justificacion: null " + "\n ";
	// else
	// return "Agente Emisor :" + identAgente + " MensajePropuesta :+" +
	// decisionMsg + "  Justificacion: " + decisionInfo.toString() +"\n ";
	// }

	@Override
	public String toString() {
		if (identObjectRefDecision == null)
			return "DecisionAgente:->  Agente Emisor :" + identAgente
					+ " identObjectRefDecision :+" + identObjectRefDecision
					+ " MensajeDecision :+" + decisionMsg
					+ "  Justificacion: null " + "\n ";
		else
			return "DecisionAgente:->  Agente Emisor :" + identAgente
					+ " identObjectRefDecision :+" + identObjectRefDecision
					+ " MensajeDecision :+" + decisionMsg + "  Justificacion: "
