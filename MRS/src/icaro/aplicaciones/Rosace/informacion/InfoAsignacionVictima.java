...
public class InfoAsignacionVictima implements Serializable {
	...
	private Map<String, Victim> victims2Rescue = new HashMap<String, Victim>(); // Victimas
																				// que
																				// hay
																				// en
																				// el
	...
	public InfoAsignacionVictima(int numVictimasEntorno,
			int numRobotsSimulacion, int intervSecuencia) {
	...
	/*
	 * public void setInfoCtxAsignacion(InfoContextoAsignacionVictima
	 * infoContxVict) { infoCtxtAsingacionVictima = infoContxVict; } public
	 * InfoContextoAsignacionVictima getInfoCtxAsignacion() { return
	 * infoCtxtAsingacionVictima ; }
	 */
}
