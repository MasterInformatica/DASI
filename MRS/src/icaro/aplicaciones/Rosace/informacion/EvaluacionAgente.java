...
public class EvaluacionAgente implements Serializable {
	...
	public String objectEvaluationId; // identificador de la victima sobre la
										// que se realiza la evaluacion
	...
	public String toString() {
		...
		return "Agente Emisor :" + identAgente + "+  Valor Evaluacion :+"
				+ valorEvaluacion + " Ident Obejeto Evaluacion : +"
				+ objectEvaluationId + "\n ";
