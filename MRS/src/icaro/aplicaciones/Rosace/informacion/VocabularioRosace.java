...
public class VocabularioRosace extends NombresPredefinidos {
	...
	public static final String IdentEquipoJerarquico = "Jerarquico"; // /ES LO
																		// QUE
																		// ESTABA
																		// ANTES
	...
	public static final String IdentAgteDistribuidorTareas = IdentEquipoJerarquico
			+ "RobotAsignador";
	...
	// identificadores de propiedades globales que hay en fichero de descripcion
	// de la organizacion asociadas a aplicaciones rosace
	...
	// tiempo de espera antes de que inicie la verificacion de la comunicacion
	// con el jefe en un equipo jerarquico con cambio de rol
	...
	static public final String IdenRecursoPersistenciaMRS  = "RecursoPersistenciaMRS1";
	...
	// Valores de los inputs del agente controlador. Son necesarios para que el
	// visualizador envie notificaciones y para definir
	// el automata
	...
	static public enum PeticionAgteControlSimul {
		TerminarSimulacion, mostrarEscenarioActualSimulado, pararRobot, sendSequenceOfSimulatedVictimsToRobotTeam, enviarIdentsEquipo
	};
}
