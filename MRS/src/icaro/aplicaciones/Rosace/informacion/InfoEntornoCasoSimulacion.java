...
public class InfoEntornoCasoSimulacion {
	...
	private long tiempoInicioSimulacion = 0; // Variable para obtener el tiempo
												// al iniciar la simulacion
	private int nroVictimasenEntorno = 0; // Numero de victimas actuales que se
	...
	public InfoEntornoCasoSimulacion(String idEquipo, int numRobotsSimulacion,
			int numVictimasEntorno, int intervSecuencia) {
		equipoId = idEquipo;
