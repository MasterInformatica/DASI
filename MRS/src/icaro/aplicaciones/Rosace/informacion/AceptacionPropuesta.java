...
public class AceptacionPropuesta implements Serializable {
	...
	public String identAgente; // Identificador del agente que emite la
	...
	public AceptacionPropuesta(String nombreAgenteEmisor,
			String mensajeAceptacionPropuesta, PropuestaAgente propAConfirmar) {
	...
	// msgAceptacionPropuesta+ "  Propuesta: "+propuestaAceptada.toString()
	// +"\n ";
	// }
