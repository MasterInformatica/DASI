...
public class Victim implements Serializable {
	...
	// Requirements. Robot abilities should cover these requirements to heal the
	// victim.
	...
	// In our first scenario (1 injured group, 1 new injured) this constructor
	// was used.
	...
	public Victim(String name, Coordinate coorVictim, int priority,
	...
	public String toString() {
		return "Victim: " + " name->" + this.getName() + " ; coordinate->"
				+ this.getCoordinateVictim() + " ; priority->"
				+ this.getPriority() + " ; requirements->"
	...
	public Point getLocPoint() {
		...
		if (this.coordinateVictim == null)
			this.coordinateVictim = new Coordinate(victimCoordinateP.x,
					victimCoordinateP.y, 0);
