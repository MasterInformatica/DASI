...
public class RobotStatusUtils {
	...
	public RobotStatusUtils(String id, int engergylevel, Coordinate coordinate,
			float healrange) {
		this.id = id;
	...
	public String toString() {
		return "Robot: id->" + this.getRobotID() + " ; engergylevel->"
				+ this.getRobotEnergyLevel() + " ; coordinate->"
				+ this.getRobotInitialCoordinate() + " ; healrange->"
				+ this.getRobotHealRange();
	}
}
