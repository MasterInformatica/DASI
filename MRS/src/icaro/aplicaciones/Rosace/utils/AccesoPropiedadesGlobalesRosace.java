...
public class AccesoPropiedadesGlobalesRosace {
	...
	// getValorNumericoPropiedadGlobal Se utiliza para obtener el valor numerico
	// de una propiedad global cuya cadena es un numero
	// VocabularioRosace.NombreDeLaPropiedadGlobal es el parametro de este
	// metodo
	// Por ejemplo se pasaria
	// VocabularioRosace.intervaloMilisegundosEnvioCCMensajes para obtener el
	// numero que indica a que ritmo se envia una secuencia
	public static int getValorNumericoPropiedadGlobal(String nombrePropiedad) {
		...
		try {
			...
			strvalorPropiedad = itfconfig
					.getValorPropiedadGlobal(nombrePropiedad);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	// getValorCadenaPropiedadGlobal Se utiliza para obtener el valor de la
	// cadena de una propiedad
	// VocabularioRosace.NombreDeLaPropiedadGlobal es el parametro de este
	// metodo
	// Por ejemplo se pasaria VocabularioRosace.identificadorEquipo para obtener
	// el identificador de equipo indicado en la propiedad global
	public static String getValorCadenaPropiedadGlobal(String nombrePropiedad) {
		...
		String strAUX = valorPropiedad.replaceAll(" ", ""); // elimina los
															// espacios en
															// blanco que podria
															// haber en los
															// numeros
	...
	public static String getIdentificadorEquipo() {
		...
		try {
			...
			identificadorEquipo = itfconfig
					.getValorPropiedadGlobal(VocabularioRosace.identificadorEquipo);
		} catch (Exception e) {
			e.printStackTrace();
		}

		String strAUX = identificadorEquipo.replaceAll(" ", ""); // elimina los
																	// espacios
																	// en blanco
																	// que
																	// podria
	...
	public static String getRutaFicheroVictimasTest() {
		...
		String strAUX = rutaFicheroVictimasTest.replaceAll(" ", ""); // elimina
																		// los
																		// espacios
																		// en
																		// blanco
	...
	public static String getRutaFicheroRobotsTest() {
		...
		String strAUX = rutaFicheroRobotsTest.replaceAll(" ", ""); // elimina
																	// los
																	// espacios
																	// en blanco
																	// que
	...
	public static int getIntervaloEnvioMensajesDesdeCC() {
		...
		try {
			...
			itfconfig = (ItfUsoConfiguracion) itfUsoRepositorioInterfaces
					.obtenerInterfaz(NombresPredefinidos.NOMBRE_ITF_USO_CONFIGURACION);
			strintervaloEnvioMensajesDesdeCC = itfconfig
					.getValorPropiedadGlobal(VocabularioRosace.intervaloMilisegundosEnvioCCMensajes);
		} catch (Exception e) {
			e.printStackTrace();
		}

		// convertir a int la cadena leida de la propiedad global
		String strAUX = strintervaloEnvioMensajesDesdeCC.replaceAll(" ", ""); // elimina
																				// los
																				// espacios
																				// en
																				// blanco
	...
	public static int getTimeTimeoutMilisegundosRecibirEvaluaciones() {
		...
		try {
			...
			itfconfig = (ItfUsoConfiguracion) itfUsoRepositorioInterfaces
					.obtenerInterfaz(NombresPredefinidos.NOMBRE_ITF_USO_CONFIGURACION);
			strtimeTimeoutRecibirEvaluaciones = itfconfig
					.getValorPropiedadGlobal(VocabularioRosace.timeTimeoutMilisegundosRecibirEvaluaciones);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static int getTimeTimeoutMilisegundosRecibirPropuestaDesempate() {
		...
		try {
			...
			itfconfig = (ItfUsoConfiguracion) itfUsoRepositorioInterfaces
					.obtenerInterfaz(NombresPredefinidos.NOMBRE_ITF_USO_CONFIGURACION);
			strtimeTimeoutRecibirPropuestaDesempate = itfconfig
					.getValorPropiedadGlobal(VocabularioRosace.timeTimeoutMilisegundosRecibirPropuestaDesempate);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static int getTimeTimeoutMilisegundosRecibirRespPropuestasIrYo() {
		...
		try {
			...
			itfconfig = (ItfUsoConfiguracion) itfUsoRepositorioInterfaces
					.obtenerInterfaz(NombresPredefinidos.NOMBRE_ITF_USO_CONFIGURACION);
			strtimeTimeoutMilisegundosRecibirRespPropuestasIrYo = itfconfig
					.getValorPropiedadGlobal(VocabularioRosace.timeTimeoutMilisegundosRecibirRespPropuestasIrYo);
		} catch (Exception e) {
			e.printStackTrace();
		}

		// convertir a int la cadena leida de la propiedad global
		String strAUX = strtimeTimeoutMilisegundosRecibirRespPropuestasIrYo
				.replaceAll(" ", "");
		timeTimeoutMilisegundosRecibirRespPropuestasIrYo = Integer
				.parseInt(strAUX);
	...
	public static String getTipoAplicacion() {
		...
		if (identificadorEquipo
				.equals(VocabularioRosace.IdentEquipoIgualitario)) {
			valorTipoAplicacion = VocabularioRosace.tipoAplicacionIgualitario;
		} else if (identificadorEquipo
