...
public class ReadXMLTestRobotsConstructorEscenarios {
	...
	private String getRobotCoordinateX(Element info, String tagcoordinate,
			String tagdimension) {
		String valuex = "";
	...
	private String getRobotCoordinateY(Element info, String tagcoordinate,
			String tagdimension) {
		String valuey = "";
		NodeList coordinateNmElmntLst = info
				.getElementsByTagName(tagcoordinate);
	...
	// System.out.println("coordinate (Coordinate(double,double,double))-> " +
