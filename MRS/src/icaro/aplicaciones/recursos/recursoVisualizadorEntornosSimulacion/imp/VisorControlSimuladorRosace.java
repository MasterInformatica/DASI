...
public class VisorControlSimuladorRosace extends javax.swing.JFrame {
	...
	public VisorControlSimuladorRosace(
			ControladorVisualizacionSimulRosace controlador) {
	...
	private void initComponents() {
		...
		jTextFieldIdentEscenarioActual
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
																...
																.addGroup(
																		layout.createParallelGroup(
																				...
																				.addComponent(
																						jPararEnvioMensajes)
																				.addComponent(
																						jtextTextFieldIntervaloEnvioMensajes,
																						javax.swing.GroupLayout.PREFERRED_SIZE,
																						101,
																						javax.swing.GroupLayout.PREFERRED_SIZE)))
												.addGroup(
														...
														layout.createSequentialGroup()
																.addGroup(
																		layout.createParallelGroup(
																				...
																				false)
																				.addComponent(
																						jScrollPanelistaIdentsVictimas,
																						javax.swing.GroupLayout.PREFERRED_SIZE,
																						0,
																						Short.MAX_VALUE)
																				.addComponent(
	...
	private void jButtonSendVictimActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonSendVictimActionPerformed
		...
		// peticion salvar victim se delega en el agente controlador. Se podria
		// implementar primero en local
		// El controlador local, mira si el usuario puede seleccionar una
		// victima y si puede le envia la peticion
	...
	private void jButtonSendVictimsSequenceActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonSendVictimsSequenceActionPerformed
		// Se deja al visualizador que obtenga el intervalo en ms . Si no hay
		// valor definido lo pide
		// por medio del Joptionpane. Le manda lo obtenido al controlador que
		// debe verificarlo
		// Si no son validos los valore debe ordenar que salga el JoptionPane
		// con los valores que correspondan y luego enviarle los valores
		...
		controladorEscSim.peticionComenzarSimulacion(identEscenarioActual,
				intervaloSecuencia);
		// jButtonStart.setEnabled(true);

		// String valorIntervaloDefinido=
		// jtextTextFieldIntervaloEnvioMensajes.getText();
		...
		// String msgUsuarioIntervaloEnvioPetcionesNoNull=
		// " El valor del intervalo en ms debe tener un valor positivo. Introduzca de nuevo el valor del intervalo";
		// while( intervaloSecuencia<=0){
		// valorIntervaloDefinido=JOptionPane.showInputDialog(rootPane,
		// msgUsuarioIntervaloEnvioPetcionesNoNull);
		// if(valorIntervaloDefinido!=null)
		// intervaloSecuencia = Integer.parseInt(valorIntervaloDefinido);
		//
		// // intervaloSecuencia = Integer.parseInt(showInputDialog(rootPane,
		// msgUsuarioIntervaloEnvioPetcionesNoNull, intervaloSecuencia));
		// }
		...
		// intervaloSecuencia =
		// Integer.parseInt(jtextTextFieldIntervaloEnvioMensajes.getText());

		// String smsg =
		// "Este es el valor en milisegundos leido de la propiedad global \nintervaloMilisegundosEnvioMensajesDesdeCC establecido \n en la descripcion de la organizacion lanzada";
		// valor = JOptionPane.showInputDialog(rootPane, smsg,
		// intervaloSecuencia);

		// String valor =
		// JOptionPane.showInputDialog("Introduce el valor en milisegundos en que deben enviarse las coordenadas");
		...
		// while (intervaloSecuencia == 0 ){
		// valor = JOptionPane.showInputDialog(rootPane,
		// "El valor debe ser  un numero entero. Introduzca de nuevo el valor del intervalo");
		...
		// }
		// }else {
		// intervaloSecuencia = 1;// si es null es que se ha cancelado y hay que
		// salir
		// }
		// }
	...
	private void jPararEnvioMensajesActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jPararEnvioMensajesActionPerformed
		// TODO add your handling code here:

		controladorEscSim.peticionPararSimulacion();
	}// GEN-LAST:event_jPararEnvioMensajesActionPerformed

	private void jButtonMostrarEscenarioActualActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonMostrarEscenarioActualActionPerformed
		// TODO add your handling code here:
	...
	private void jlistIdentsRobotsMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jlistIdentsRobotsMouseClicked
		if (evt.getClickCount() == 2) {
			...
			// notifEvts.sendPeticionPararAgente
			// ((String)identsRobotsEquipo.get(index));
	...
	private void jMenuItemCrearEscenarioActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jMenuItemCrearEscenarioActionPerformed
		...
		// // Se avisa de que el escenario actual se va a guardar antes de abrir
		// el nuevo
		// //
	...
	private void jMenuItemAbrirEscenarioActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jMenuItemAbrirEscenarioActionPerformed
		// TODO add your handling code here:
		controladorEscSim.peticionAbrirEscenario();
		// FileNameExtensionFilter filter = new
		// FileNameExtensionFilter("ficheros xml","xml","txt" );
		//
		...
		// escenarioActualComp =
		// persistencia.obtenerInfoEscenarioSimulacion(selectedFile.getAbsolutePath());
	...
	private void jPopupMenuAcionesRobotsPopupMenuWillBecomeVisible(
			javax.swing.event.PopupMenuEvent evt) {// GEN-FIRST:event_jPopupMenuAcionesRobotsPopupMenuWillBecomeVisible
		// TODO add your handling code here:
	}// GEN-LAST:event_jPopupMenuAcionesRobotsPopupMenuWillBecomeVisible

	private void jTextFieldIdentEscenarioActualActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jTextFieldIdentEscenarioActualActionPerformed
		// TODO add your handling code here:
	...
	private void jListIdentsVictimsMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jListIdentsVictimsMouseClicked
		...
		if (evt.getClickCount() == 2) {
			...
			controladorEscSim
					.victimaSeleccionadaParaSimulacion(identVictimaSeleccionada);
		}
	...
	public void solicitarDefinicionItervaloSecuencia() {
		String valorIntervaloDefinido = jtextTextFieldIntervaloEnvioMensajes
				.getText();
		if (valorIntervaloDefinido.equals(""))
			intervaloSecuencia = 0;
		else
			intervaloSecuencia = Integer.parseInt(valorIntervaloDefinido);
		setLocationRelativeTo(this);
		...
		while (intervaloSecuencia <= 0 && ventanaAbierta) {
			...
			else if (valorIntervaloDefinido.equals(""))
				intervaloSecuencia = 0;
			else
				intervaloSecuencia = Integer.parseInt(valorIntervaloDefinido);
		}
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(
					VisorControlSimuladorRosace.class.getName()).log(
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			...
			@Override
			public void run() {
				// new VisorControlSimuladorRosace(new
				// ControladorVisualizacionSimulRosace()).setVisible(true);
			}
		});
	}
