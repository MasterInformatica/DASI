...
public class GestionEscenariosSimulacion {
	...
	public synchronized String getIdentEscenario(String orgTipo, int numRobts,
			int numVictm) {
		String identEscenario = orgModelo + orgTipo + numRobots + numRobts
				+ numVictims + numVictm + "_0";
	...
	public EscenarioSimulacionRobtsVictms crearEscenarioSimulacion() {
		...
		// escenarioSim.setIdentEscenario(getIdentEscenario (orgModeloInicial,0,
		// 0));
