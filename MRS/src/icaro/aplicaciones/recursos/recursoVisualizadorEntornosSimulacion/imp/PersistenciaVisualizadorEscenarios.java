...
public class PersistenciaVisualizadorEscenarios {
	...
	public void guardarInfoEscenarioSimulacion(
			String rutaFicheroInfoPersistencia,
			EscenarioSimulacionRobtsVictms escenario) {
		Serializer serializer = new Persister();
		String identFichero = rutaFicheroInfoPersistencia
				+ escenario.getIdentEscenario() + ".xml";
		try {
			...
			System.out.println("En el fichero   : "
					+ rutaFicheroInfoPersistencia + identFichero);
		...
		try {
			...
			if (!dirFicherosPersistencia.exists()) {
				System.out.println("El fichero   : "
						+ rutaFicheroInfoPersistencia + " No existe ");
				// rutaFicheroInfoPersistencia=
				// dirFicherosPersistencia.getAbsolutePath()+"\\";
	...
	public HashSet obtenerIdentsEscenarioSimulacion(
			String rutaDirectorioInfoPersistencia) {
