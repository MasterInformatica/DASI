...
public class ControladorEditorEntornosSimulacion {
	...
	public ControladorEditorEntornosSimulacion(
			NotificadorInfoUsuarioEdicionEscenarios notificadorInfoUsuarioSimulador) {
	...
	// public void peticionComenzarSimulacion(String identEquipoActual, int
	// intervaloSecuencia) {
	// // throw new UnsupportedOperationException("Not supported yet."); //To
	// change body of generated methods, choose Tools | Templates.
	// if ( escenarioActualComp
	// ==null)visorControlSim.visualizarConsejo(tituloAvisoEscenarioNoDefinido,mensajeEscenarioNoDefinido,recomendacionDefinirEscenario);
	// else if (identEquipoActual==
	// null)visorControlSim.setIdentEquipo(escenarioActualComp.getIdentEscenario());
	// else if (intervaloSecuencia
	// <=0)visorControlSim.solicitarDefinicionItervaloSecuencia();
	// else
	...
	public void peticionAbrirEscenario() {
		...
		File ficheroSeleccionado = visorEditorEscen
				.solicitarSeleccionFichero(directorioPersistencia);
		if (ficheroSeleccionado == null)
			visorEditorEscen.visualizarConsejo(tituloAvisoEscenarioNoDefinido,
	...
	public static void main(String args[]) {
		...
		new ControladorEditorEntornosSimulacion(
				new NotificadorInfoUsuarioEdicionEscenarios("prueba1",
						"agente2")).initModelosYvistas();
	...
	void peticionGuardarEscenario() {
		...
		if (escenarioActualComp.getNumRobots() <= 0)
			...
			if (respuesta == JOptionPane.OK_OPTION)
				persistencia.guardarInfoEscenarioSimulacion(
						directorioPersistencia, escenarioActualComp);
	...
	void peticionMostrarEscenarioActual() {
		...
		if (escenarioActualAbierto)
			visorEditorEscen.setVisible(true);
		else if (escenarioActualComp == null)
			visorEditorEscen.visualizarConsejo(tituloAvisoEscenarioNoDefinido,
	...
	// change body of generated methods, choose Tools | Templates.
	// if
	// (identList!=null)visorControlSim.visualizarIdentsEquipoRobot(identList);
	// }
