...
public class RecursoPersistenciaEntornosSimulacionImp extends ImplRecursoSimple {
	...
	public RecursoPersistenciaEntornosSimulacionImp(String recursoId)
	...
	public void inicializarRecursoPersistenciaEntornosSimulacion() {
		try {
			...
			rutaFicheroVictimasTest = itfconfig
					.getValorPropiedadGlobal(VocabularioRosace.identRutaFicheroEscenarioSimulacion);
			rutaFicheroRobotsTest = itfconfig
			...
			if ((rXMLTSeq != null) && (nodeLst != null))
				numeroVictimasDiferentesSimulacion = rXMLTSeq
						.getNumberOfVictimsInSequence(nodeLst);
			// se obtienen tambien el conjunto de vicitmas definidas
			// String nombreFicheroAsignVictim = "asigVictimasObjetos";
			directorioPersistencia = VocabularioRosace.IdentDirectorioPersistenciaSimulacion
					+ File.separator;
			identFicheroInfoAsigVictimasObj = directorioPersistencia
					+ VocabularioRosace.NombreFicheroSerieInfoAsignacionVictimas
					+ ".tmp";
			identFicheroInfoAsigVictimasXML = directorioPersistencia
					+ VocabularioRosace.NombreFicheroSerieInfoAsignacionVictimas
					+ ".xml";
			...
			Logger.getLogger(
					RecursoPersistenciaEntornosSimulacionImp.class.getName())
