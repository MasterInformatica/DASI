...
public class ReadXMLTestSequence {
	...
	// Obtain information about name for the current victim (contained in
	// Element info)
	...
	// Obtain information about arrival time for the current victim (contained
	// in Element info)
	...
	// Obtain information about severity for the current victim (contained in
	// Element info)
	...
	// Obtain information about x coordinate for the current victim (contained
	// in Element info)
	// tagcoordinate parameter should be equal to "coordinate"
	// tagdimension parameter should be equal to "x"
	private String getVictimCoordinateX(Element info, String tagcoordinate,
			String tagdimension) {
		String valuex = "";
	...
	// Obtain information about y coordinate for the current victim (contained
	// in Element info)
	// tagcoordinate parameter should be equal to "coordinate"
	// tagdimension parameter should be equal to "y"
	private String getVictimCoordinateY(Element info, String tagcoordinate,
			String tagdimension) {
		String valuey = "";
		NodeList coordinateNmElmntLst = info
				.getElementsByTagName(tagcoordinate);
	...
	// Obtain information about z coordinate for the current victim (contained
	// in Element info)
	// tagcoordinate parameter should be equal to "coordinate"
	// tagdimension parameter should be equal to "z"
	private String getVictimCoordinateZ(Element info, String tagcoordinate,
			String tagdimension) {
		String valuez = "";
		NodeList coordinateNmElmntLst = info
				.getElementsByTagName(tagcoordinate);
	...
	// Obtain information about coordinates for the current victim (contained in
	// Element info)
	public Coordinate getVictimCoordinate(Element info) {

		Coordinate victimCoordinate = new Coordinate(Double.parseDouble(this
				.getVictimCoordinateX(info, "coordinate", "x")),
				Double.parseDouble(this.getVictimCoordinateY(info,
						"coordinate", "y")), Double.parseDouble(this
						.getVictimCoordinateZ(info, "coordinate", "z")));
		return victimCoordinate;
	}

	// Obtain information about all requirements for the current victim
	// (contained in Element info)
	public List<Integer> getVictimRequirements(Element info) {

		List<Integer> victimRequirements = new ArrayList<Integer>();

		NodeList requirementsNmElmntLst = info
				.getElementsByTagName("requirements");
		...
		if (requirementsNode.getNodeType() == Node.ELEMENT_NODE) {
			...
			NodeList requirementNmElmntLst = requirementsInfo
			...
			for (int reqindex = 0; reqindex < requirementNmElmntLst.getLength(); reqindex++) {
				Element requNmElmnt = (Element) requirementNmElmntLst
						.item(reqindex);
